...
## Project Structure
    ...
    ├── pocket_concierge_30532  # Django project configurations
...
1. Clone this repo and `cd pocket_concierge_30532`
...
2. Clone this repo and `cd pocket_concierge_30532`
